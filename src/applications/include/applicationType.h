...
public:
     ...
     **/
    virtual std::pair<std::string, std::string> getLocation() = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, std::string> > getExistingRequiredFiles(std::string args, std::shared_ptr<ns3lxc::Node> nodePtr) = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, std::string> > getRequiredFiles(std::string args, std::shared_ptr<ns3lxc::Node> nodePtr) = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, bool> > getExecutionCommands(std::string args, std::shared_ptr<ns3lxc::Node> nodePtr) = 0;
