...
public:
     ...
     **/
    virtual std::pair<std::string, std::string> getLocation(yntdl::Application *app) = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, std::string> > getExistingRequiredFiles(yntdl::Application *app, std::shared_ptr<yntdl::Node> nodePtr) = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, std::string> > getRequiredFiles(yntdl::Application *app, std::shared_ptr<yntdl::Node> nodePtr) = 0;
     ...
     **/
    virtual std::vector<std::pair<std::string, bool> > getExecutionCommands(yntdl::Application *app, std::shared_ptr<yntdl::Node> nodePtr) = 0;

    /**
     * Returns a list of locations to grab files from the node (like log files)
     **/
    virtual std::vector<std::string> getCleanupLocations(yntdl::Application *app, std::shared_ptr<yntdl::Node> nodePtr) = 0;
     ...
     **/
    virtual std::vector<std::string> getCleanupCommands(yntdl::Application *app, std::shared_ptr<yntdl::Node> nodePtr) = 0;
};
