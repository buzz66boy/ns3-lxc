...
public:
    ...
    virtual std::string getConfigFilename(std::string args, std::shared_ptr<ns3lxc::Node>, std::shared_ptr<ns3lxc::Topology>) override;
    virtual std::string writeConfig(std::string args, std::shared_ptr<ns3lxc::Node>, std::shared_ptr<ns3lxc::Topology>, std::ostream) override;
