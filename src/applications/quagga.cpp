...
std::vector<std::pair<std::string, std::string> > Quagga::getExistingRequiredFiles(std::string args, std::shared_ptr<ns3lxc::Node> nodePtr){
    vector<pair<string, string> > existingFiles;
    return existingFiles;
}
std::vector<std::pair<std::string, std::string> > Quagga::getRequiredFiles(std::string args, std::shared_ptr<ns3lxc::Node> nodePtr){
...
std::vector<std::pair<std::string, bool> > Quagga::getExecutionCommands(std::string args, std::shared_ptr<ns3lxc::Node>){
