...
std::string Quagga::getConfigFilename(std::string args, std::shared_ptr<ns3lxc::Node>, std::shared_ptr<ns3lxc::Topology>){
    return "";
}
std::string Quagga::writeConfig(std::string args, std::shared_ptr<ns3lxc::Node>, std::shared_ptr<ns3lxc::Topology>, std::ostream){
    return "";
}
